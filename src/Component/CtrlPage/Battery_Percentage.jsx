...
function Battery_Percentage(popup) {
  ...
  return (
    <div>
      ...
      <div className={`w-48 mt-5 grid justify-items-center ${popup.power>75? "" : "hidden"}`}>
        <div className="shadow w-1/2 rounded border-2 border-gray-400 flex my-1 relative">
          ...
          <div
            ...
            style={scope.full}>
            <div className="absolute left-0 mx-8 text-gray-700">100%</div>
          </div>
        </div>
      </div>

      <div className={`w-48 mt-5 grid justify-items-center ${popup.power>50 && popup.power <=75 ? "" : "hidden"}`}>
        <div className="shadow w-1/2 rounded border-2 border-gray-400 flex my-1 relative">
          <div
            className="border-r-8 h-6 rounded-r absolute flex border-gray-400 ml-24 mt-2 z-10"></div>
          <div
            ...
            <div className="absolute left-0 mx-8 text-gray-700">75%</div>
          </div>
        </div>
      </div>

      <div className={`w-48 mt-5 grid justify-items-center ${popup.power>25 && popup.power <=50 ? "" : "hidden"}`}>
        <div className="shadow w-1/2 rounded border-2 border-gray-400 flex my-1 relative">
          <div
            className="border-r-8 h-6 rounded-r absolute flex border-gray-400 ml-24 mt-2 z-10"></div>
          <div
            ...
            style={scope.half}>
            <div className="absolute left-0 mx-8 text-gray-700">50%</div>
          </div>
        </div>
      </div>

      <div className={`w-48 mt-5 grid justify-items-center ${popup.power>10 && popup.power <=25 ? "" : "hidden"}`}>
        <div className="shadow w-1/2 rounded border-2 border-gray-400 flex my-1 relative">
          <div
            className="border-r-8 h-6 rounded-r absolute flex border-gray-400 ml-24 mt-2 z-10"></div>
          <div
            ...
            style={scope.quarter}>
            <div className="absolute left-0 mx-8 text-gray-700">25%</div>
          </div>
        </div>
      </div>

      <div className={`w-48 mt-5 grid justify-items-center ${popup.power <= 10 ? "" : "hidden"}`}>
        <div className="shadow w-1/2 rounded border-2 border-gray-400 flex my-1 relative">
          <div
            className="border-r-8 h-6 rounded-r absolute flex border-gray-400 ml-24 mt-2 z-10"></div>
          <div
